...
if __name__=='__main__':
    ...
    test_type2tpch('tpch_simple_edited', pg_details, 'tpch_simplebench.json', 'tpch_simplestats')
    ...
    test_type2spider('spider_simple_edited', pg_details, 'spider_simplebench.json', 'spider_simplestats')
